...
export function AvatarSelector() {
  ...
  function buy() {
    ...
    const newStats = {
      ...currentUser.stats,
      coins: currentUser.stats.coins - avatarInfo[currentAvatar].cost,
    };
  ...
  function sell() {
    if (
      ...
      const newBoughtAvatars = currentUser.owned_avatar_ids.filter(
    ...
    <View style={[styles.container]}>
      ...
      >
        ...
        <View style={{ flexDirection: "row", width: "90%" }}>
          ...
          {!avatarChecker() ? (
            <TouchableOpacity
              disabled={coins < avatarInfo[currentAvatar].cost}
              style={[
                styles.button,
            ...
            <TouchableOpacity
              style={[
                styles.button,
                avatarChecker() ? styles.disabledButton : null,
              ]}
              onPress={sell}
            >
          ...
          Number(currentUser.avatar_uri) !== currentAvatar ? (
            <TouchableOpacity
              ...
              style={[
                styles.button,
                { width: "50%" },
                avatarChecker() ? null : styles.disabledButton,
              ]}
              onPress={select}
            >
